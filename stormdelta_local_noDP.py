...
def storm_motion_deltas_local(REFlev, REFlev1, big_storm, numsecs, zero_z_trigger, storm_to_track, year, month, day, hour, start_min, duration, calibration, offhodoshear, station, localfolder, Bunkers_s, Bunkers_m, meanw_s, meanw_m, shear_dir, track_dis, GR_mins=1.0):
    #Set storm motion
    Bunkers_m = Bunkers_m
